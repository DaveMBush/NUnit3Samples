...
namespace NUnit3Samples._4._Basic_Testing
{
    ...
    public class SetupAndTeardown
    {
        ...
        {
            Console.WriteLine("This runs once before all of the test in this test fixture");
        }

        [OneTimeTearDown]
        public void OneTimeTearDown()
        {
            Console.WriteLine("This runs once after all of the test in this test fixture");
        }
